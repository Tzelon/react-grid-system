...
export function cloneLayoutItem(layoutItem) {
  return {
    ...
    // These can be null
    isDraggable: layoutItem.isDraggable, isResizable: layoutItem.isResizable, itemSizes: [].concat(_toConsumableArray(layoutItem.itemSizes))
  };
}
...
export function setTopLeft(_ref2) {
  var top = _ref2.top,
      left = _ref2.left,
      width = _ref2.width,
      height = _ref2.height;
