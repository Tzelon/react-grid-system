...
var GridItemExtend = function (_React$Component) {
    ...
    function GridItemExtend() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GridItemExtend.__proto__ || Object.getPrototypeOf(GridItemExtend)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            _this.onResizeHandler("onResize")(null, { node: null, size: { left: 0, top: 0, width: item.value[0] * 85, height: item.value[1] * 85 } });
            _this.onResizeHandler("onResizeStop")(null, { node: null, size: { left: 0, top: 0, width: item.value[0] * 85, height: item.value[1] * 85 } });
        ...
        value: function mixinHeader(child) {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'span',
                        { className: 'icon-container', onMouseDown: this.onMouseDownPreventDrag,
                            onClick: this.props.onRemoveItem },
                        React.createElement(Close, null)
                    ),
                    !isEmpty(this.props.itemSizes) && React.createElement(
                        DropdownMenu,
                        { itemClick: this.onItemClick, className: 'icon-container' },
                        this.props.itemSizes.map(function (item) {
                            return React.createElement(
                                ListItem,
                                { key: item.join('x'), name: item.join('x'), value: item },
                                React.createElement(
                                    'span',
                                    null,
                                    item.join('x')
                                ...
                                ' ',
                                React.createElement(Grid, { size: item })
                            );
                        })
                    )
                ),
